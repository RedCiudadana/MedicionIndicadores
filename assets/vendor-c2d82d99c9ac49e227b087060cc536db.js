...
e&&(t=require("request"))
var r=!1,n=!1
try{void 0!==(new XMLHttpRequest).withCredentials?r=!0:"XDomainRequest"in window&&(r=!0,n=!0)}catch(e){}var o=Array.prototype.indexOf,a=function(e,t){var r=0,n=e.length
if(o&&e.indexOf===o)return e.indexOf(t)
for(;r<n;r++)if(e[r]===t)return r
return-1},s=function(t){if(!(this&&this instanceof s))return new s(t)
"string"==typeof t&&(t={key:t}),this.callback=t.callback,this.wanted=t.wanted||[],this.key=t.key,this.simpleSheet=!!t.simpleSheet,this.parseNumbers=!!t.parseNumbers,this.wait=!!t.wait,this.reverse=!!t.reverse,this.postProcess=t.postProcess,this.debug=!!t.debug,this.query=t.query||"",this.orderby=t.orderby,this.endpoint=t.endpoint||"https://spreadsheets.google.com",this.singleton=!!t.singleton,this.simpleUrl=!(!t.simpleUrl&&!t.simple_url),this.authkey=t.authkey,this.sheetPrivacy=this.authkey?"private":"public",this.callbackContext=t.callbackContext,this.prettyColumnNames=void 0===t.prettyColumnNames?!t.proxy:t.prettyColumnNames,void 0!==t.proxy&&(this.endpoint=t.proxy.replace(/\/$/,""),this.simpleUrl=!0,this.singleton=!0,r=!1),this.parameterize=t.parameterize||!1,this.singleton&&(void 0!==s.singleton&&this.log("WARNING! Tabletop singleton already defined"),s.singleton=this),/key=/.test(this.key)&&(this.log("You passed an old Google Docs url as the key! Attempting to parse."),this.key=this.key.match("key=(.*?)(&|#|$)")[1]),/pubhtml/.test(this.key)&&(this.log("You passed a new Google Spreadsheets url as the key! Attempting to parse."),this.key=this.key.match("d\\/(.*?)\\/pubhtml")[1]),/spreadsheets\/d/.test(this.key)&&(this.log("You passed the most recent version of Google Spreadsheets url as the key! Attempting to parse."),this.key=this.key.match("d\\/(.*?)/")[1]),this.key?(this.log("Initializing with key "+this.key),this.models={},this.modelNames=[],this.model_names=this.modelNames,this.baseJsonPath="/feeds/worksheets/"+this.key+"/"+this.sheetPrivacy+"/basic?alt=",this.baseJsonPath+=e||r?"json":"json-in-script",this.wait||this.fetch()):this.log("You need to pass Tabletop a key!")}
...
r="tt"+ +new Date+Math.floor(1e5*Math.random()),s.callbacks[r]=function(){var e=Array.prototype.slice.call(arguments,0)
t.apply(i,e),n.parentNode.removeChild(n),delete s.callbacks[r]},r="Tabletop.callbacks."+r}var o=e+"&callback="+r
...
r.call(n,i)})},isWanted:function(e){return 0===this.wanted.length||-1!==a(this.wanted,e)},data:function(){if(0!==this.modelNames.length)return this.simpleSheet?(this.modelNames.length>1&&this.debug&&this.log("WARNING You have more than one sheet but are using simple sheet mode! Don't blame me when something goes wrong."),this.models[this.modelNames[0]].all()):this.models},addWanted:function(e){-1===a(this.wanted,e)&&this.wanted.push(e)},loadSheets:function(t){var n,i,o=[]
for(this.googleSheetName=t.feed.title.$t,this.foundSheetNames=[],n=0,i=t.feed.entry.length;n<i;n++)if(this.foundSheetNames.push(t.feed.entry[n].title.$t),this.isWanted(t.feed.entry[n].content.$t)){var a=t.feed.entry[n].link.length-1,s=t.feed.entry[n].link[a].href.split("/").pop(),u="/feeds/list/"+this.key+"/"+s+"/"+this.sheetPrivacy+"/values?alt="
u+=e||r?"json":"json-in-script",this.query&&(u+="&tq="+this.query),this.orderby&&(u+="&orderby=column:"+this.orderby.toLowerCase()),this.reverse&&(u+="&reverse=true"),o.push(u)}for(this.sheetsToLoad=o.length,n=0,i=o.length;n<i;n++)this.requestData(o[n],this.loadSheet)},sheets:function(e){return void 0===e?this.models:void 0===this.models[e]?void 0:this.models[e]},sheetReady:function(e){this.models[e.name]=e,-1===a(this.modelNames,e.name)&&this.modelNames.push(e.name),this.sheetsToLoad--,0===this.sheetsToLoad&&this.doCallback()},loadSheet:function(e){var t=this
new s.Model({data:e,parseNumbers:this.parseNumbers,postProcess:this.postProcess,tabletop:this,prettyColumnNames:this.prettyColumnNames,onReady:function(){t.sheetReady(this)}})},doCallback:function(){0===this.sheetsToLoad&&this.callback.apply(this.callbackContext||this,[this.data(),this])},log:function(){this.debug&&"undefined"!=typeof console&&void 0!==console.log&&Function.prototype.apply.apply(console.log,[console,arguments])}},s.Model=function(e){var t,r,n,i
...
for(this.originalColumns=this.columnNames,this.original_columns=this.originalColumns,t=0,n=e.data.feed.entry.length;t<n;t++){var a=e.data.feed.entry[t],s={}
for(r=0,i=this.columnNames.length;r<i;r++){var u=a["gsx$"+this.columnNames[r]]
void 0!==u?e.parseNumbers&&""!==u.$t&&!isNaN(u.$t)?s[this.columnNames[r]]=+u.$t:s[this.columnNames[r]]=u.$t:s[this.columnNames[r]]=""}void 0===s.rowNumber&&(s.rowNumber=t+1),this.elements.push(s)}e.prettyColumnNames?this.fetchPrettyColumns():this.ready()},s.Model.prototype={all:function(){return this.elements},fetchPrettyColumns:function(){if(!this.raw.feed.link[3])return this.ready()
...
for(e=0,r=this.elements.length;e<r;e++){var a={}
for(t=0,n=this.columnNames.length;t<n;t++){a[this.prettyColumns[this.columnNames[t]]]=this.elements[e][this.columnNames[t]]}i.push(a)}this.elements=i,this.columnNames=o},toArray:function(){var e,t,r,n,i=[]
...
return{default:Tabletop}}),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
