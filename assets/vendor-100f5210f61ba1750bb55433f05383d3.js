...
if(a=f=u=i=i||r,3!==i.nodeType&&8!==i.nodeType&&!bt.test(v+_.event.triggered)&&(v.indexOf(".")>-1&&(v=(g=v.split(".")).shift(),g.sort()),c=v.indexOf(":")<0&&"on"+v,(t=t[_.expando]?t:new _.Event(v,"object"==typeof t&&t)).isTrigger=o?2:3,t.namespace=g.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+g.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),n=null==n?[t]:_.makeArray(n,[t]),h=_.event.special[v]||{},o||!h.trigger||!1!==h.trigger.apply(i,n))){if(!o&&!h.noBubble&&!b(i)){for(l=h.delegateType||v,bt.test(l+v)||(a=a.parentNode);a;a=a.parentNode)y.push(a),u=a
u===(i.ownerDocument||r)&&y.push(u.defaultView||u.parentWindow||e)}for(s=0;(a=y[s++])&&!t.isPropagationStopped();)f=a,t.type=s>1?l:h.bindType||v,(d=(Y.get(a,"events")||{})[t.type]&&Y.get(a,"handle"))&&d.apply(a,n),(d=c&&a[c])&&d.apply&&G(a)&&(t.result=d.apply(a,n),!1===t.result&&t.preventDefault())
...
function Oe(e){return ke[e]}function Te(e){return null===e||void 0===e?e="":"string"!=typeof e&&(e=""+e),new xe(e)}function Pe(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}var Ae=void 0,Se=void 0
...
return vt++,pt.join(null,bt)}vt=0,null!==yt&&(t=yt.resolve,yt=null,pt.join(null,t))})
var gt=function(){function e(e,t){var n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:c.fallbackViewRegistry,r=arguments.length>3&&void 0!==arguments[3]&&arguments[3]
...
return r!==e&&(t=jt(this.sourceReference,r),n.inner.update(t.tag),this.innerReference=t,this.lastPath=r),t.value()},n.prototype[A]=function(e){(0,s.set)(this.sourceReference.value(),this.pathReference.value(),e)},n}(M),It=function(e){function t(t,n,o){var s=(0,r.possibleConstructorReturn)(this,e.call(this))
...
var t=e.named
return g.QueryParams.create({values:(0,a.assign)({},t.value())})}var Bt=["alt","shift","meta","ctrl"],Ht=/^click|mouse|touch/
...
function yn(e){return{object:"component:"+e}}function vn(e){return void 0!==e?{source:"template:"+e}:void 0}function gn(e){var t=f.FACTORY_FOR.get(e)
...
return i[Ft]=r,i[K]=r[A],i[Lt]=!0,i},"query-params":function(e,t){return new q(zt,t.capture())},readonly:function(e,t){var n=function(e){return e[Ft]||e}(t.positional.at(0)),r=Object.create(n)
...
return n[he]=!0,n},"-input-type":function(e,t){return new q(Pt,t.capture())},"-normalize-class":function(e,t){return new q(At,t.capture())},"-html-safe":function(e,t){return new q(Tt,t.capture())},"-get-dynamic-var":t.getDynamicVar,"-mount":function(e,t){var n=e.env,r=t.positional.at(0),i=t.named.has("model")?t.named.get("model"):void 0
...
return void 0!==t?t:null},e.prototype._lookupComponentDefinition=function(e,t){var n,r=(0,c.lookupComponent)(t.owner,e,vn(t.moduleName)),i=r.layout,o=r.component,u=(0,a.guidFor)(t.owner)+"|"+gn(o)+"|"+gn(i),l=this.componentDefinitionCache.get(u)
...
return g(r,e._router,i+"_"+n,o)?o:""}function v(e,n){var r=(0,t.getOwner)(e),i=e.routeName,o=e.fullRouteName,s=e._router,a="application"===o?n:o+"."+n
...
r?(this._result[t]=n,(i=g(this._mapFn)(n,t))===m?this._settledAt(f,t,i.error,!1):this._eachEntry(i,t,!1)):(this._remaining--,n||(this._result[t]=J))},n}($)
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}var l,c,p,d,h,f,m,b,y,v,g,_,E,w,x,k,C
